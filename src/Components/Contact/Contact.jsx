                ...
                <div className="bg-white p-6 lg:p-8 flex-1 rounded-md shadow-md">
                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-3 gap-6'>
                        <div className="text-center ">
                            ...
                            <p className="text-gray-700">infojobvista@gmail.com</p>
                            <p className="text-gray-700">jobsatjobvista@gmail.com</p>
                        </div>
                        <div className="text-center ">
                            ...
                            <p className="text-gray-700">+91 000 444 0004</p>
                        </div>
                        <div className="text-center ">
                            ...
                            <p className="text-gray-700">Contact us anytime for assistance.</p>
                        </div>
                    </div>
                    <div className="mt-8">
                        <h3 className="text-xl lg:text-2xl font-semibold mb-4 text-center">Join Our Job Portal</h3>
                        <p className="text-gray-700">
                            Explore exciting job opportunities and take the next step in your career with our job portal.
                        </p>
                        <p className="text-gray-700">
                            Browse through a wide range of job listings and find the perfect match for your skills and aspirations.
                        </p>
                    </div>
                </div>
